...
public class Db extends SQLiteOpenHelper {
    ...
    public static String DB_NAME="yourdb.sqlite3";
    public static final int DB_VERSION = 1;
    private String t;

    public static final String USER= "friends";
    ...
    public String getAllUser(){
        ...
        String[] t1 = {t};
        try{
            c = db.rawQuery("select * from " + USER + " where _id = ? ",t1);
            Log.d("Intent","I"+ Arrays.toString(t1));
            if(c == null)return null;
            c.moveToFirst();
            listUsers = c.getString(1)+":"+c.getString(2)+":"+c.getString(3);
